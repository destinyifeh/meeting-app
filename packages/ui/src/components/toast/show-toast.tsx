...
export const SuccessToast = ({
  ...
  <button
    className={classNames(
      "bg-success text-white mb-2 flex h-auto space-x-2 rounded-md p-4 text-[14px] font-medium",
...
export const ErrorToast = ({
  ...
  <button
    className={classNames(
      "bg-error text-white mb-2 flex h-auto space-x-2 rounded-md p-4 text-[14px] font-medium",
      toastVisible && "cursor-pointer"
    )}
    onClick={() => onClose(toastId)}
  >
